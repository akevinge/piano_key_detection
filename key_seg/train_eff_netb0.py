...
utils.make_directory_force_recursively("models/efficientnet_piano_key")
torch.save(model.state_dict(), "models/efficientnet_piano_key/model.pth")
...
plt.ylabel("Loss")
plt.grid(True)
utils.make_directory_force_recursively("models/efficientnet_piano_key/plots")
plt.savefig(
    "models/efficientnet_piano_key/plots/training_loss.png",
    dpi=300,
    bbox_inches="tight",
)
plt.close()
